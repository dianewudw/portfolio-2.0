...
export default function Contact(){
    ...
    return(
        <>
            <div className='flex flex-col h-full w-full p-5 lg:px-24 lg:pt-24 text-white'>
                <NavigationBar />
                <div class={` ${poppins.className} flex lg:mt-30 h-lvh lg:h-svh justify-center w-full flex-col flex-row`}>
                    <div class='flex w-full flex-col h-full lg:h-4/5 lg:flex-row justify-center bg-white/[0.05] my-10 lg:my-20 rounded-lg py-10'>
